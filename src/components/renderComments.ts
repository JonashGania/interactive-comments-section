...
import { sortCommentsByScore, getDateCreated } from '../utils/utils';
import {
  handleReplyButton,
  handleDeleteComment,
  replySubmission,
...
//                             <span class="comment-date-created">${getDateCreated(comment.createdAt)}</span>
//                         </div>
//                         <div class="edit-delete-container">
//                             <button class="delete-btn">
//                                 <svg width="12" height="14" xmlns="http://www.w3.org/2000/svg" class="delete-icon">
...
//     const userAvatar = UserAvatar(comment.user.image.png, comment.user.image.webp);
//     const replyLists = ReplyCard(comment.replies, comment.id, comment.replies.length);
...
//       replySubmission(addReply, comment.id, comment.replies.length, comment.user.username);
//       form.classList.add('close');
//     });

//     if (cancelBtn && deleteBtn && yesDeleteBtn && overlay && modalContainer) {
//       deleteBtn.forEach((deleteButton) => {
//         handleDeleteComment(cancelBtn, deleteButton, yesDeleteBtn, overlay, modalContainer, comment.id);
//       });
//     }
...
//     handleUpdateCommentScore(upvoteBtn, downvoteBtn, voteScoreSpan, comment.id);
